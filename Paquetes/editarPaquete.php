...
<div class="container-fluid mt-4 form-container">
  ...
  <form action="../procesos/editarPaquete.php" method="post" class="form-horizontal">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="number" class="form-control" id="precio" name="precio" required value="<?php echo $datos['precio']; ?>"></td>
      </tr>
      <tr>
