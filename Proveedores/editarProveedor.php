  ...
  <form action="../procesos/editarProveedor.php" method="post" class="form-horizontal" onsubmit="return validateForm()">
    ...
    <table>
      ...
      <tr>
        ...
        <td><input type="text" class="form-control" id="servicios_ofrecidos" name="servicios_ofrecidos" required value="<?php echo implode(', ', (array)$datos['servicios_ofrecidos']); ?>"></td>
      </tr>
      <tr>
