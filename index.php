...
<nav class="navbar navbar-expand-lg navbar-custom">
    <div class="container-fluid">
        <a class="navbar-brand navbar-brand-custom" href="./index.php">Gestión de Eventos <i class="fa-brands fa-docker"></i> </a>
        ...
        <div class="col-md-4">
            <div class="card animate__animated animate__zoomIn">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Nuestro equipo se encarga de todos los detalles, desde la planificación inicial hasta la
        ...
        <div class="col-md-4">
            <div class="card animate__animated animate__zoomIn">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Nuestro servicio de catering ofrece una variedad de menús personalizados para satisfacer
                        todos los gustos y necesidades dietéticas. Desde aperitivos hasta platos principales y postres, garantizamos
